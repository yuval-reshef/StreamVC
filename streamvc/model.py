...
class StreamVC(nn.Module):
    def __init__(self, samples_per_frame: int, sample_rate: int, yin_thresholds: tuple[float]):
        super().__init__()
        ...
        self.f0_estimator = F0Estimator(sample_rate, samples_per_frame, yin_thresholds=yin_thresholds, whitening=True)
